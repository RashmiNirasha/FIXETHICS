...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO issues(issue,fullname,email,telno,message) VALUES('$issue','$fullname','$email','$telephone','$promessage')";
...
<head>
    ...
    <link href="assets/css/topnav.css" rel="stylesheet" type="text/css">
